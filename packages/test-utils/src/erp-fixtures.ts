...
export function makeAnimals() {
  const list = [
    ...
    { id: 'an-013', name: 'Jingga', species: 'Reticulated Giraffe', sex: 'F', enclosure: 'Savanna', age: 12, status: 'healthy', conservation: 'Vulnerable' },
    { id: 'an-014', name: 'Lumba', species: 'Reticulated Giraffe', sex: 'M', enclosure: 'Savanna', age: 15, status: 'monitoring', conservation: 'Vulnerable' },
    { id: 'an-015', name: 'Flora', species: 'Greater Flamingo', sex: 'F', enclosure: 'Wetland Aviary', age: 9, status: 'healthy', conservation: 'Least Concern' },
    { id: 'an-016', name: 'Garuda', species: 'Javan Hawk-eagle', sex: 'M', enclosure: 'Bird Aviary', age: 6, status: 'healthy', conservation: 'Endangered' },
    { id: 'an-017', name: 'Belang', species: 'Malayan Tapir', sex: 'M', enclosure: 'Forest Loop', age: 10, status: 'healthy', conservation: 'Endangered' },
    { id: 'an-018', name: 'Sinta', species: 'Bornean Orangutan', sex: 'F', enclosure: 'Primate House', age: 17, status: 'monitoring', conservation: 'Critically Endangered' },
  ] as const;
  return list;
}
...
export function makeSafetyIncidents() {
  return [
    ...
    {
      id: 'inc-006',
      title: 'Slippery walkway after rain — Gate B',
      severity: 'low' as const,
      status: 'closed' as const,
      reportedBy: 'Gate Officer Indah',
      location: 'Gate B Entrance',
      reportedAt: pastH(140),
      closedAt: pastH(138),
      injuries: 0,
      type: 'facility',
    },
    {
      id: 'inc-007',
      title: 'Elephant minor agitation during feeding',
      severity: 'medium' as const,
      status: 'closed' as const,
      reportedBy: 'Curator Made',
      location: 'Savanna',
    ...
    {
      id: 'inc-008',
      title: 'Visitor lost child — reunited',
      severity: 'medium' as const,
      status: 'closed' as const,
      reportedBy: 'Info Desk',
      location: 'Main Plaza',
      reportedAt: pastH(30),
      closedAt: pastH(29.4),
      injuries: 0,
    ...
    {
      id: 'inc-009',
      title: 'Generator fault — Reptile Hall',
      severity: 'high' as const,
      status: 'investigating' as const,
      reportedBy: 'Maintenance',
      location: 'Reptile Hall',
      reportedAt: pastH(10),
      closedAt: null,
      injuries: 0,
      type: 'facility',
    ...
    {
      id: 'inc-010',
      title: 'Shuttle bus minor fender bump',
      severity: 'low' as const,
      status: 'open' as const,
      reportedBy: 'Driver Teguh',
      location: 'Parking C',
      reportedAt: pastH(4),
      closedAt: null,
      injuries: 0,
    ...
    {
      id: 'inc-011',
      title: 'Heat exhaustion — visitor recovered',
      severity: 'medium' as const,
      status: 'closed' as const,
      reportedBy: 'First Aid Office',
...
export function makeCompliance() {
  ...
  const documents = [
    ...
    { id: 'doc-008', name: 'Veterinary clinic licence', authority: 'Dinas Peternakan', expires: today + 160 * 86_400_000, status: 'valid' as const },
    { id: 'doc-009', name: 'Water discharge permit', authority: 'Dinas Lingkungan Hidup', expires: today + 30 * 86_400_000, status: 'expiring-soon' as const },
    { id: 'doc-010', name: 'CITES export — orangutan exchange', authority: 'KLHK', expires: today + 410 * 86_400_000, status: 'valid' as const },
    { id: 'doc-011', name: 'Boiler & pressure vessel cert', authority: 'Disnaker', expires: today - 3 * 86_400_000, status: 'expired' as const },
    { id: 'doc-012', name: 'Halal certification — F&B', authority: 'BPJPH', expires: today + 220 * 86_400_000, status: 'valid' as const },
    { id: 'doc-013', name: 'Crowd & event safety permit', authority: 'Polres Bogor', expires: today + 18 * 86_400_000, status: 'expiring-soon' as const },
  ];
...
export function makeVendors() {
  return [
    ...
    { id: 'ven-007', name: 'PT. Logistik Nusantara', category: 'Logistics', rating: 4.3, onTimePct: 90, lastDelivery: pastD(4), activeOrders: 2 },
    { id: 'ven-008', name: 'CV. Taman Lestari', category: 'Landscaping', rating: 4.5, onTimePct: 94, lastDelivery: pastD(6), activeOrders: 1 },
    { id: 'ven-009', name: 'PT. Energi Surya Mandiri', category: 'Utilities', rating: 4.1, onTimePct: 97, lastDelivery: pastD(9), activeOrders: 0 },
    { id: 'ven-010', name: 'Bersih Jaya Cleaning Svc.', category: 'Facilities', rating: 4.4, onTimePct: 92, lastDelivery: pastD(1), activeOrders: 3 },
    { id: 'ven-011', name: 'CV. Aman Sentosa Security', category: 'Security', rating: 4.6, onTimePct: 96, lastDelivery: pastD(2), activeOrders: 1 },
    { id: 'ven-012', name: 'PT. Cetak Grafika Prima', category: 'Print & Signage', rating: 3.9, onTimePct: 85, lastDelivery: pastD(11), activeOrders: 2 },
  ];
}
...
export function makeCampaigns() {
  return [
    ...
    },
    {
      ...
      channel: 'Email + Push',
      audience: 'Adult tier holders',
      sent: 612,
      opened: 421,
      clicked: 132,
      conversions: 29,
      revenueIdr: 43_500_000,
      status: 'running' as const,
      startsAt: pastD(12),
      endsAt: inD(18),
    },
    ...
    {
      id: 'camp-009',
      name: 'Win-back · lapsed 90d',
      channel: 'Email + SMS',
      audience: 'Expired pass holders',
      sent: 326,
      opened: 188,
      clicked: 74,
      conversions: 21,
      revenueIdr: 17_850_000,
      status: 'running' as const,
      startsAt: pastD(6),
      endsAt: inD(24),
    },
    {
      id: 'camp-010',
      name: 'Night Safari · final week',
      channel: 'Push',
      audience: 'Bogor members',
      sent: 940,
      opened: 712,
      clicked: 263,
      conversions: 58,
      revenueIdr: 19_720_000,
